				...
				<div class="widget-content">
					...
					<table class="table">
						...
						<tr>
							...
							<td>
								<a href="<?php echo $this->url->getUrl('administrator/LanguageEditor', 'edit', [urlencode($file['file'])]); ?>" class="btn btn-primary"><i class="fa fa-edit" title="<?php echo $text_edit; ?>"></i></a>
							</td>
						</tr>
						<?php } ?>
					</table>
